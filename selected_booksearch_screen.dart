...
import '../models/searchbook_model.dart';
import '../widgets/custom_tab_indicator.dart';
import 'package:google_fonts/google_fonts.dart';


class SelectedBookSearchScreen extends StatelessWidget {
  final SearchBookModel searchBookModel;

  const SelectedBookSearchScreen({Key? key, required this.searchBookModel,})
      : super(key: key);
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: Container(
                color: Color(searchBookModel.color),
                child: SizedBox(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                           image: AssetImage(searchBookModel.image)
                          ),
                        ),
                      ),
                    ),
